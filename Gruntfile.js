...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new nest name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/admin/nest.png')) {
            fs.renameSync(__dirname + '/admin/nest.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/nest.html')) {
            fs.renameSync(__dirname + '/widgets/nest.html',           __dirname + '/widgets/' + newname + '.html');
        }
        if (fs.existsSync(__dirname + '/widgets/nest/js/nest.js')) {
            fs.renameSync(__dirname + '/widgets/nest/js/nest.js', __dirname + '/widgets/nest/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/nest')) {
            fs.renameSync(__dirname + '/widgets/nest',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /Nest/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Nest'
                        },
                        {
